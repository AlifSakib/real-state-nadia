...
export default function Home() {
  ...
  return (
   ...
   <img src={images[currentIndex]} className="  w-full h-[950px] object-cover  bg-opacity-[0.1]    border border-e-white  opacity-80   rounded-b-3xl  " />
   <div className="absolute top-0 w-full">
     <Nav />
   </div>
   <div className="absolute md:left-20   left-5 md:top-80 top-60 ">
     <div className="text-slate-200 text-sm  font-Oswald ">
     {a[currentIndex]}
     </div>
     <div className="text-white md:text-6xl font-Oswald text-2xl mt-6 mb-6 font-extrabold ">
     {b[currentIndex]}
       <br />
       {d[currentIndex]}
     </div>
   ...
   <div className="absolute md:top-[883px] top-[585px] w-full h-16 flex justify-between">
     <button
