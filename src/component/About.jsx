...
<Nav/>
   ...
   <div className=" md:flex justify-center items-center pt-20 md:gap-7 w-full  mx-auto  p-0 " >
     <div className="  md:w-[700px] w-[300px] md:p-0 p-3 ">
       <h1 className="  font-Oswald  md:text-7xl text-3xl font-extrabold  mb-8">
         About Us
       </h1>
     ...
     <div className="  md:mt-20     mt-0 ">
       ...
       <img src={image} className=" w-[700px] object-cover " />
     </div>
